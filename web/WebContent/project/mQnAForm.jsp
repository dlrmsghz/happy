...
<body>
	...
	<%if(count == 0){ %>
		<table class="table">
			<tr>
				<td><button onclick="window.location='mQnAwrite.jsp'">글쓰기</button></td>
			</tr>
			<tr>
	...
	<%}else{ %>
			...
			<tr>
					<%if(id!= null&&id.equals("admin")) {%>
						<td colspan="6" align="right">
							<button onclick="window.location='mQnAwrite.jsp'">글쓰기</button>
						</td>
					<%} %>
			</tr>
			<tr>
		...
		<%} %>	
			<tr>
				<td colspan="6">
					<button onclick="window.location='mMain.jsp'">메인으로</button>
				</td>
			</tr>
	</table>
	<%} %>
