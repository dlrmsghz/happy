...
<body>
	...
	<div>
		<table class="table">
			<tr>
				<td align="center">
					<input type = "button" value = "등록" onclick = "window.location.href='mBookListInputForm.jsp'"/>
		...
		<table class="table">
			<tr>
				<td colspan="8" align="right">
					...
					<input type = "button" value = "책등록" onclick = "window.location.href='mBookListInputForm.jsp'"/>
					<%} %>
				</td>
			</tr>
			<tr>
