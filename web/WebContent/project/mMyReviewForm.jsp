			...
			<form action="mReviewDeletePro.jsp" method="post">
					<table class="table">
						...
						<tr>
							...
							<td>
								<input type="button" value="수정" onclick="window.location.href='mReviewModifyForm.jsp?num=<%=review.getNum()%>&id=<%=review.getId()%>'">
							</td>
						</tr>
						<%} %>
						<tr>
							<td colspan="7">
								...
								<input type="button" value="마이페이지" onclick="window.location.href='mMypageForm.jsp'">
							</td>
						</tr>
					</table>
			</form>
