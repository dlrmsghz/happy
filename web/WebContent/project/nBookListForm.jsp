...
<body>
	...
	<table class="table">
		<tr>
		<td>
			<input type = "button" value = "등록" onclick = "window.location.href='nBookListInputForm.jsp'"/>
	...
	<table class="table">
		<tr>
			<td colspan="8" align="right">
				<input type = "button" value = "메인화면" onclick= "window.location.href='mMain.jsp'"/>
				<input type = "button" value = "책등록" onclick = "window.location.href='nBookListInputForm.jsp'"/>
